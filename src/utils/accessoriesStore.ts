      ...
      for (const station of stations) {
        ...
        for (const device of stationDevices) {
          ...
          const deviceRecord: Record<string, any> = {
            ...
            isGarageCamera: device.isCamera() && (device as any).isGarageCamera?.(),
            hasDoor1: device.hasProperty(PropertyName.DeviceDoor1Open),
            hasDoor2: device.hasProperty(PropertyName.DeviceDoor2Open),
            disabled: false,
