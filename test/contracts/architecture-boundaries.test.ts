...
const allowedDependencies: Readonly<Record<string, ReadonlySet<string>>> = {
  ...
  platform: new Set(['configuration', 'device', 'homekit', 'media', 'runtime', 'settings', 'storage']),
  runtime: new Set(['account', 'configuration', 'device', 'runtime']),
  settings: new Set(),
  storage: new Set(['account']),
  ui: new Set(['account', 'configuration', 'device', 'runtime', 'storage', 'ui']),
  version: new Set(),
};
