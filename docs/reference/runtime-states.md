...
The custom dashboard reads this tracker without creating another SDK client. It reports missing and
stale tracker evidence separately, treats an incomplete inventory as incomplete rather than ready, and
may show the retained latest complete device snapshot while the runtime is degraded.
